$( function() {
	"use strict";
	$('.infobox').hide();
	$('#tnt-remarks-table').find('tr').click( function(){
	...
	$('#remarks-details-link').click( function(){
		$('.infobox-nav-link').removeClass('active');
		$(this).addClass('active');
		$('.infobox-content').hide();
		$('#container-details-content').show();
	});
	//open TNT ADD REMARKS Popup
	$('#tnt-remarks-add-button').click( function(){
	  $('#tnt-add-remarks-popup').dialog('open');
	});
});